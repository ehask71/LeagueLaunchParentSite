...
////////////////////////////////////////////////////////////
    ...
    public function chargeFromCart($data, $cart) {
        ...
        $post_values = array(
            ...
            'x_type' => 'AUTH_CAPTURE',
            'x_method' => 'CC',
            'x_card_num' => $data['Order']['ccnum'],
            'x_exp_date' => $data['Order']['ccmonth'] . $data['Order']['ccyear'],
            'x_card_code' => $data['Order']['cc_code'],
            'x_invoice_num' => '',
            'x_tax' => '0.00',
            'x_amount' => $cart['Order']['total'],
            'x_description' => '',
            'x_first_name' => $data['Order']['firstname'],
            'x_last_name' => $data['Order']['lastname'],
            'x_address' => $data['Order']['billing_address'],
            'x_city' => $data['Order']['billing_city'],
            'x_state' => $data['Order']['billing_state'],
            'x_zip' => $data['Order']['billing_zip'],
            'x_country' => $data['Order']['billing_country'],
            'x_ship_to_first_name' => $data['Order']['firstname'],
            'x_ship_to_last_name' => $data['Order']['lastname'],
            'x_ship_to_address' => $data['Order']['shipping_address'],
            'x_ship_to_city' => $data['Order']['shipping_city'],
            'x_ship_to_state' => $data['Order']['shipping_state'],
            'x_ship_to_zip' => $data['Order']['shipping_zip'],
            'x_ship_to_country' => $data['Order']['shipping_country'],
            'x_cust_id' => '',
            'x_phone' => $data['Order']['phone'],
            'x_email' => $data['Order']['email'],
            'x_customer_ip' => $_SERVER['REMOTE_ADDR'],
        );
